...
export class EditFieldsComponent  implements OnInit{
  ...
  ngOnInit(): void {
    this.name = this.editfieldData.name
    this.selectedStation = this.editfieldData.station
    this.selectedCropType = this.editfieldData.cropType
    this.selectedCrop = this.editfieldData.crop
    this.plannedDate = this.editfieldData.plantingDate
    this.StartOfRapidGrowth = this.editfieldData.crpDateDev
    this.StartOfMidSeason = this.editfieldData.crpDateMid
    this.BeginingOfSeason = this.editfieldData.crpDateLate
    this.EndOfSeason = this.editfieldData.crpDateHarv
    this.InitialKcb = this.editfieldData.crpKcbInit
    this.MaximumKcb = this.editfieldData.crpKcbMid
    this.EndKcb = this.editfieldData.crpKcbEnd
    this.SelectedInitialCropHeight = this.editfieldData.crpHtInit
    this.SelectedMaximumCropHeight = this.editfieldData.crpHtMax
    this.SelectedInitialRootDepth = this.editfieldData.crpRtInit
    this.SelectedMaximumRootDepth = this.editfieldData.crpRtMax
    this.SelectedSoilVolume = this.editfieldData.irrSoilVolWat
    this.SelectedLayer = this.editfieldData.soilNoOfLayers
    this.SelectedSoilType1 = this.editfieldData.soilType1
    this.SelectedSoilType2 = this.editfieldData.soilType2
    this.SelectedSoilType3 = this.editfieldData.soilType3
    this.SelectedSoilType4 = this.editfieldData.soilType4
    this.SelectedSoilType5 = this.editfieldData.soilType5
    this.SelectedSoilType6 = this.editfieldData.soilType6
    this.SelectedREW = this.editfieldData.rew
    this.SelectedTEW = this.editfieldData.tew
    this.SelectedDepth1 = this.editfieldData.soilLayer1Depth
    this.SelectedDepth2 = this.editfieldData.soilLayer2Depth
    this.SelectedDepth3 = this.editfieldData.soilLayer3Depth
    this.SelectedDepth4 = this.editfieldData.soilLayer4Depth
    this.SelectedDepth5 = this.editfieldData.soilLayer5Depth
    this.SelectedDepth6 = this.editfieldData.soilLayer6Depth
    this.SelectedSoilWateratfieldCapacity1 = this.editfieldData.soilSWCFc1
    this.SelectedSoilWateratfieldCapacity2 = this.editfieldData.soilSWCFc2
    this.SelectedSoilWateratfieldCapacity3 = this.editfieldData.soilSWCFc3
    this.SelectedSoilWateratfieldCapacity4 = this.editfieldData.soilSWCFc4
    this.SelectedSoilWateratfieldCapacity5 = this.editfieldData.soilSWCFc5
    this.SelectedSoilWateratfieldCapacity6 = this.editfieldData.soilSWCFc6
    this.SelectedPermentWiltingPoint1 = this.editfieldData.soilSWPWp1
    this.SelectedPermentWiltingPoint2 = this.editfieldData.soilSWPWp2
    this.SelectedPermentWiltingPoint3 = this.editfieldData.soilSWPWp3
    this.SelectedPermentWiltingPoint4 = this.editfieldData.soilSWPWp4
    this.SelectedPermentWiltingPoint5 = this.editfieldData.soilSWPWp5
    this.SelectedPermentWiltingPoint6 = this.editfieldData.soilSWPWp6
    this.SelectedInitialSoilwaterDeficit1 = this.editfieldData.soilInitWatDeficit1
    this.SelectedInitialSoilwaterDeficit2 = this.editfieldData.soilInitWatDeficit2
    this.SelectedInitialSoilwaterDeficit3 = this.editfieldData.soilInitWatDeficit3
    this.SelectedInitialSoilwaterDeficit4 = this.editfieldData.soilInitWatDeficit4
    this.SelectedInitialSoilwaterDeficit5 = this.editfieldData.soilInitWatDeficit5
    this.SelectedInitialSoilwaterDeficit6 = this.editfieldData.soilInitWatDeficit6
    this.SelectedMAD1 = this.editfieldData.soilMAD1
    this.SelectedMAD2 = this.editfieldData.soilMAD2
    this.SelectedMAD3 = this.editfieldData.soilMAD3
    this.SelectedMAD4 = this.editfieldData.soilMAD4
    this.MAD1From = this.editfieldData.soilMAD1FromDate
    this.MAD1To = this.editfieldData.soilMAD1ToDate
    this.MAD2From = this.editfieldData.soilMAD2FromDate
    this.MAD2To = this.editfieldData.soilMAD2ToDate
    this.MAD3From = this.editfieldData.soilMAD3FromDate
    this.MAD3To = this.editfieldData.soilMAD3ToDate
    this.MAD4From = this.editfieldData.soilMAD4FromDate
    this.MAD4To = this.editfieldData.soilMAD4ToDate
    this.SelectedIrrigationSystem = this.editfieldData.irrSys
    this.SelectedIrrigationfw = this.editfieldData.irrFw

    this.LayerUpdate = this.SelectedLayer
  }
  ...
  postDate() {
    ...
    this.irrigationService.posteditData(postData)
  }
